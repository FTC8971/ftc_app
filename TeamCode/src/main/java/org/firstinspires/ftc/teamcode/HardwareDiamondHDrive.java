 ...
 */
public class HardwareDiamondHDrive
{
    ...
    public void init(HardwareMap ahwMap) {
        ...
        centerMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);//set the center wheels to rotate freely when stopped
